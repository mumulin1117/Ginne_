...
import UIKit
//热门
class KZQXPopularDrink: UIViewController,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout{
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        let vcGtua = ZPXQStepDetailView.init(detgiolGTEA: mojitoAcholeData[indexPath.row])
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let gtehCell = collectionView.dequeueReusableCell(withReuseIdentifier:"VQZTPopularItemCellID", for: indexPath) as! VQZTPopularItemCell
    ...
    override func viewDidLoad() {
        ...
        let topcell = UINib(nibName: "VQZTPopularItemCell", bundle: nil)
        homewrserDataView.register(topcell, forCellWithReuseIdentifier: "VQZTPopularItemCellID")
