...
//Search
class QX7RSearchPulseCore: UIViewController {
    ...
    @IBAction func startSerachingOkay(_ sender: Any) {
        ...
        guard let comeingtitle = serchingTexGTUA.text,comeingtitle.count != 0 else {
            SVProgressHUD.showInfo(withStatus: gintuemojir(f1g2h3i4j5: "Thhjef yskepayrwcshq lcsoqnwtgeanotf yceaynuneoytr wbxev aevmrpatiyi!"))
            return
        }
