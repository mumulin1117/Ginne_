...
class Z5W8BalanceCore: UIViewController,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        dataVireGTEm.register(UINib.init(nibName: "M4Z9BalanceNode", bundle: nil), forCellWithReuseIdentifier: "M4Z9BalanceNodeID")
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let gtemcell = collectionView.dequeueReusableCell(withReuseIdentifier: "M4Z9BalanceNodeID", for: indexPath) as! M4Z9BalanceNode
